...
{
    public static BSSiseveeb.Public.Web.Controllers.AccountController Account = new BSSiseveeb.Public.Web.Controllers.T4MVC_AccountController();
    public static BSSiseveeb.Public.Web.Controllers.AdminController Admin = new BSSiseveeb.Public.Web.Controllers.T4MVC_AdminController();
    public static BSSiseveeb.Public.Web.Controllers.ErrorController Error = new BSSiseveeb.Public.Web.Controllers.T4MVC_ErrorController();
    public static BSSiseveeb.Public.Web.Controllers.HomeController Home = new BSSiseveeb.Public.Web.Controllers.T4MVC_HomeController();
    public static BSSiseveeb.Public.Web.Controllers.MenuController Menu = new BSSiseveeb.Public.Web.Controllers.T4MVC_MenuController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static readonly string addemployee_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/addemployee.min.js") ? Url("addemployee.min.js") : Url("addemployee.js");
        public static readonly string adminrequests_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/adminrequests.min.js") ? Url("adminrequests.min.js") : Url("adminrequests.js");
        public static readonly string adminvacations_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/adminvacations.min.js") ? Url("adminvacations.min.js") : Url("adminvacations.js");
        public static readonly string adminvacations_min_js = Url("adminvacations.min.js");
        ...
        public static readonly string jquery_birthday_picker_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/jquery-birthday-picker.min.js") ? Url("jquery-birthday-picker.min.js") : Url("jquery-birthday-picker.js");
        ...
        public static readonly string requests_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/requests.min.js") ? Url("requests.min.js") : Url("requests.js");
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            public static class Assets
            {
                ...
                public const string account_js = "~/Scripts/account.js"; 
                public const string addemployee_js = "~/Scripts/addemployee.js"; 
                public const string adminrequests_js = "~/Scripts/adminrequests.js"; 
                public const string adminvacations_js = "~/Scripts/adminvacations.js"; 
                ...
                public const string general_js = "~/Scripts/general.js"; 
                ...
                public const string jquery_birthday_picker_js = "~/Scripts/jquery-birthday-picker.js"; 
                ...
                public const string requests_js = "~/Scripts/requests.js"; 
